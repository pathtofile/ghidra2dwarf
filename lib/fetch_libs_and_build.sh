...
[ ! -f src/main/resources/linux-x86-64/libdwarf.so ] && \
    curl -o src/main/resources/linux-x86-64/libdwarf.so -L --create-dirs https://github.com/pathtofile/libdwarf-ghidra2dwarf/releases/download/latest/libdwarf.so
